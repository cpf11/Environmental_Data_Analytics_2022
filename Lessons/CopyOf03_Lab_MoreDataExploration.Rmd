...
```{r}
hightemperatures_f<-c(42,45,48,35,43,52,51,60,66,59)
lowtemperatures_f<-c(20,27,27,15,26,25,33,49,48,27)
```
...
```{r}
hightemperatures_c<-c(6,7,9,1,6,11,10,15,19,15)
lowtemperatures_c<-c(-7,-3,-3,-10,-4,-4,1,9,9,-3)
...
convertftoc(hightemperatures_f)
convertftoc(lowtemperatures_f)
```

Combine your four vectors into a data frame and add informative column names.

```{r}
durhamforecast_ten <- data.frame(hightemperatures_f,lowtemperatures_f,hightemperatures_c,lowtemperatures_c)
names(durhamforecast_ten) <- c("High Temperatures Fahrenheit","Low Temperatures Fahrenheit","High Temperatures Celsius", "Low Temperatures Celsius"); View(durhamforecast_ten)
```
...
```{r}
summary(durhamforecast_ten)
sd(durhamforecast_ten$`High Temperatures Fahrenheit`)
```
