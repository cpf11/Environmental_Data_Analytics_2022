...
ggplot(EPAair) +
  geom_point(aes(x=PM2.5, y = Ozone, color = meanlat)) +
  ylab(expression("Surface Temperature"))
...
EPAair.Ex3<-
  ...
  ylab(expression("0"[3]* "AQI Value")) #use expression if we want more than just characters, e.g. when you add degree symbol. Don't need expression when its just characters.
print(EPAair.Ex3)
