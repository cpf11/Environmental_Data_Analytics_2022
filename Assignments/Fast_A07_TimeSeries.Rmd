...
> Answer: There is no stark difference in the conclusions extrapolated from this new Mann Kendall test that was generated for the non-seasonal Ozone monthly series. The test demonstrates a negative trend, but it is still statistically insignificant (tau = -0.105, 2-sided pvalue =0.088483). While it is approaching more statistically significant than the previous test, it is still above our alpha of 0.05. 
